...
// Ruta pública para mantener activo el proyecto en Supabase (usado por cron-job.org)
Route::get('/ping', function () {
    try {
        ...
        return response()->json([
            ...
            'db'     => 'unavailable',
            'time'   => now()->toDateTimeString(),
        ], 200); // 200 para que el cron no lo marque como fallo
    }
});
...
Route::middleware(['auth:sanctum', 'rol:decano'])->group(function () {
    ...
    Route::get('/periodos/anios', [PeriodoController::class, 'indexAnios']);
    Route::post('/periodos/anios', [PeriodoController::class, 'storeAnio']);
    Route::put('/periodos/anios/{id}/activar', [PeriodoController::class, 'activarAnio']);
...
Route::middleware(['auth:sanctum', 'rol:director'])->group(function () {
    ...
    Route::get('/director/periodos', [PeriodoController::class, 'index']);
    Route::post('/director/periodos', [PeriodoController::class, 'store']);
    Route::put('/director/periodos/{id}', [PeriodoController::class, 'update']);
    Route::delete('/director/periodos/{id}', [PeriodoController::class, 'destroy']);
    Route::put('/director/periodos/{id}/activar', [PeriodoController::class, 'activar']);
    // Horarios
...
// Rutas para centro_estudiantes y centro_facultativo
Route::middleware(['auth:sanctum', 'rol:centro_estudiantes,centro_facultativo'])->group(function () {
    Route::post('/usuarios/{usuario}/asignar-centro-estudiantes', [UsuarioController::class, 'asignarCentroEstudiantes']);
});
