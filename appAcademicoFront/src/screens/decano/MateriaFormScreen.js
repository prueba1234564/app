...
export default function MateriaFormScreen({ navigation, route }) {
  ...
  const [selectedSeccion, setSelectedSeccion] = useState(materia?.seccion ?? '');
        ...
        <View style={styles.formCard}>
          ...
          {selectedCarrera ? (
            <View style={styles.sectionSelector}>
              <Text style={styles.inputLabel}>Selecciona {selectedCarrera.tipo === 'semestral' ? 'semestre' : 'año'}</Text>
